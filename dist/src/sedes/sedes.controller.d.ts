...
export declare class SedesController {
    ...
    createSede(createSedeDto: CreateSedeDto): Promise<{
        canchas: {
            id: string;
            nombre: string;
            createdAt: Date;
    ...
    findAllSedes(ciudad?: string, activo?: string): Promise<({
        _count: {
            canchas: number;
    ...
    updateSede(id: string, updateSedeDto: UpdateSedeDto): Promise<{
        canchas: {
            id: string;
            nombre: string;
            createdAt: Date;
    ...
    createCancha(sedeId: string, createCanchaDto: CreateSedeCanchaDto): Promise<{
        id: string;
        nombre: string;
        createdAt: Date;
        tipo: import(".prisma/client").$Enums.TipoCancha;
    ...
    updateCancha(sedeId: string, canchaId: string, updateCanchaDto: UpdateSedeCanchaDto): Promise<{
        id: string;
        nombre: string;
        createdAt: Date;
        tipo: import(".prisma/client").$Enums.TipoCancha;
