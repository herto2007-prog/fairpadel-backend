...
export declare class InscripcionesController {
    ...
    create(createInscripcionDto: CreateInscripcionDto, req: any): Promise<{
        category: {
            id: string;
            nombre: string;
            createdAt: Date;
    ...
    misinscripciones(req: any): Promise<({
        category: {
            id: string;
            nombre: string;
            createdAt: Date;
    ...
    cancelar(id: string, req: any): Promise<{
        id: string;
        createdAt: Date;
        estado: import(".prisma/client").$Enums.InscripcionEstado;
        updatedAt: Date;
    ...
    subirComprobante(id: string, body: {
