...
exports.FotosModule = FotosModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [fotos_service_1.FotosService, cloudinary_service_1.CloudinaryService],
        exports: [fotos_service_1.FotosService, cloudinary_service_1.CloudinaryService],
    })
], FotosModule);
