...
export declare class AdminController {
    ...
    rechazarSolicitudOrganizador(id: string, body: {
        motivo: string;
    }): Promise<{
        message: string;
    }>;
    ...
    suspenderUsuario(id: string, body: {
        motivo: string;
    }): Promise<{
        message: string;
    }>;
    ...
    resolverReporteFoto(id: string, body: {
        accion: string;
    }): Promise<{
        message: string;
    }>;
    resolverReporteUsuario(id: string, body: {
        accion: string;
    }): Promise<{
        message: string;
    }>;
    ...
    extenderSuscripcion(id: string, body: {
        dias: number;
    }): Promise<{
        message: string;
    }>;
    ...
    actualizarConfiguracionPuntos(id: string, body: {
        puntosBase: number;
        multiplicador: number;
    }): Promise<{
        message: string;
    }>;
    crearCupon(body: any): Promise<{
        id: string;
        createdAt: Date;
        tipo: string;
        estado: string;
