  ...
  describe('mapInscripcionAuditoria', () => {
    it('inscripción completa con pago y partido programado', () => {
      const insc = {
        ...
        jugador1: { nombre: 'Ana', apellido: 'García', telefono: '0991', categoriaActual: { nombre: '4ta' } },
        jugador2: { nombre: 'Beto', apellido: 'López', telefono: '0992', categoriaActual: { nombre: '5ta' } },
    ...
    it('inscripción sin pareja ni partidos -> N/A, (Pendiente), sin slot', () => {
      const insc = {
        ...
        jugador1: { nombre: 'Ana', apellido: 'García', telefono: '0991', categoriaActual: null },
        jugador2: null,
