...
import { AdminTorneoOverviewController } from './admin-torneo-overview.controller';
import { AdminTorneoWizardController } from './admin-torneo-wizard.controller';
...
@Module({
  ...
  controllers: [
    ...
    AdminTorneoOverviewController,
    AdminTorneoWizardController,
