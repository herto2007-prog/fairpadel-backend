  ...
  private async seedWhatsAppTemplates() {
    ...
    const templates = [
      ...
      },
      {
        ...
        parametros: { contenido: 'Datos de tu reserva confirmada: Cancha numero {{1}} asignada para fecha {{2}} segun disponibilidad.', variables: ['numero_cancha', 'fecha'] },
      },
      {
        ...
        parametros: { contenido: 'Detalles de tu sede confirmada: {{1}}. Presentarse 15 minutos antes del horario.', variables: ['nombre_sede'] },
      },
      {
        ...
        parametros: { contenido: 'Fecha confirmada para tu partido: {{1}} a las {{2}} segun fixture oficial.', variables: ['fecha', 'hora'] },
      },
      {
        ...
        parametros: { contenido: 'Tu inscripcion al torneo {{1}} esta registrada en la categoria {{2}}.', variables: ['nombre_torneo', 'categoria'] },
      },
      // UTILITY (mantenidos por Meta)
      {
        ...
        parametros: { contenido: 'Recordatorio de tu reserva: El partido es manana en sede {{1}} a las {{2}} segun confirmacion previa.', variables: ['sede', 'hora'] },
      },
      {
        ...
        parametros: { contenido: 'Recordatorio para hoy: Te esperamos en sede {{1}} a las {{2}} segun tu reserva registrada.', variables: ['sede', 'hora'] },
      },
      {
        ...
        parametros: { contenido: 'Informacion de tu torneo: La pareja asignada es el jugador {{1}} en categoria {{2}} segun registro.', variables: ['nombre_pareja', 'categoria'] },
      },
      {
        ...
        parametros: { contenido: 'Informacion del fixture: El rival asignado es {{1}} en el torneo {{2}} segun programacion.', variables: ['nombre_rival', 'nombre_torneo'] },
      },
    ];
